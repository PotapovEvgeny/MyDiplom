...
- Вход в приложение с валидными учетными данными (Тест-кейсы:1,2,3,4);
- Вход в приложение с  не валидными учетными даннымии (Тест-кейсы: 1,2,3,5,6);
- Вход в приложение с пустым полем "логин" или "пароль" (Тест-кейсы: 1,2,3,7);
- Выход из учетной записи (Тест-кейс: 36).
2.Навигация по приложению: 
Переход между разделами приложения через "Главное меню":
- в раздел "News" (Тест-кейс: 9);
- в раздел "About" (Тест-кейс: 9);
- в раздел "Main"(Тест-кейс: 9) .
3.Вкладка "News":
- Кнопка свернуть/развернуть выбранную новость (Тест-кейсы: 13,14,15);
- Сортировка новостей по дате (Тест-кейс: 12);
- Фильтр по категории, по дате (Тест-кейсы: 18,19,20);
- Создание новой новости (Тест-кейс: 22);
- Редактирование новости: смена категории, смена заголовка, смена даты, смена времени, смена описания (Тест-кейсы: 23,24,25,26,27,28,29,30);
- Удаление новости (Тест-кейс: 31).
4.Вкладка "About":
- Просмотр ссылки пользовательское соглашение в разделе "About" (Тест-кейсы: 33,35);
- Просмотр ссылки «политика конфиденциальности» раздел "About" (Тест-кейсы: 33,34).
